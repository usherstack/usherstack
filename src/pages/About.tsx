...
export default function About() {
  ...
  return (
    <PageTransition>
      ...
      {/* REPLACED SECTION (was stats) */}
      <section className="py-20 bg-background border-y border-border/50">
        <div className="container mx-auto px-4 md:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto">
            <div className="p-8 rounded-2xl glass-card hover-glow transition-all">
              <h3 className="text-2xl font-bold text-primary mb-4">
                Innovation First
              </h3>
              <p className="text-lg text-muted-foreground leading-relaxed">
                We create modern digital solutions with scalability,
                performance, and clean user experience at the core.
              </p>
            </div>
            ...
            <div className="p-8 rounded-2xl glass-card hover-glow transition-all">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                UsherStack is more than a service company — it’s a platform
                where learners and creators grow together.
              </p>
            </div>
            ...
            <div className="p-8 rounded-2xl glass-card hover-glow transition-all">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                From UI/UX design to deployment and AI integration, we handle
            ...
            <div className="p-8 rounded-2xl glass-card hover-glow transition-all">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                We use modern technologies and workflows to build products
